...
1. Login to github container registry `docker login ghcr.io -u USERNAME` and ensure that it creates a config file for you (located at `/root/.docker/config.json`)
