          ...
          click: function () {
            ...
            if ($parentAnchorLink.parent('figure').length) {
              ...
              if ($parentAnchorLink.is('a')) {
                $newFigure = $parentAnchorLink.wrap('<figure style="text-align: right;" class="' + options.captionIt.figureClass + '"></figure>').parent();
                $newFigure.append('<figcaption class="' + options.captionIt.figcaptionClass + '>' + captionText + '</figcaption>');
                //$newFigure.width(imgWidth);
              } else {
                $newFigure = img.wrap('<figure style="text-align: right;"  class="' + options.captionIt.figureClass + '"></figure>').parent();
