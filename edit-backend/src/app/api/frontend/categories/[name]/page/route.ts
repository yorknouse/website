    ...
    const articles: IArticleFull[] = await Promise.all(
      category.articles.map(async ({ article }) => {
        ...
        const articleNew: IArticleFull = {
          ...
          thumbnailCredit:
            article.articlesDrafts[0]?.articlesDrafts_thumbnailCredit?.length !== 0 && article.articlesDrafts[0]?.articlesDrafts_thumbnailCredit !== null
              ? String(article.articlesDrafts[0]?.articlesDrafts_thumbnailCredit)
              : null,
          headline:
            article.articlesDrafts[0]?.articlesDrafts_headline || "Unknown",
          excerpt: article.articlesDrafts[0]?.articlesDrafts_excerpt?.length !== 0 && article.articlesDrafts[0]?.articlesDrafts_excerpt !== null
