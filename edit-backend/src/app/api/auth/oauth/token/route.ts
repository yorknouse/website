...
export async function POST(req: NextRequest) {
  ...
  if (user.users_googleAppsUsernameNouse) email = user.users_googleAppsUsernameNouse + "@nouse.co.uk"
  else if (user.users_googleAppsUsernameYork) email = user.users_googleAppsUsernameYork + "@york.ac.uk"
