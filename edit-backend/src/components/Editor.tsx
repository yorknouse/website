...
export default function DualEditor<T = void>({ initialMarkdown = "", onSubmit, confirmData }: EditorProps<T>) {
    ...
    return (
        <div className="max-w-4xl mx-auto p-4 space-y-4">
            {mode === "markdown" ? (
                ...
                <MDEditor
                    ...
                    commands={[
                        commands.group(
                            ...
                            { name: "headers", groupName: "headers", buttonProps: { title: "Headers" } }
                        ),
                        commands.bold,
                        commands.italic,
                ...
                <div style={{fontSize: "16px"}}>
                <ReactQuill theme="snow" value={html} onChange={(v = "") => setHtml(v)} />
                    </div>
            )}
