...
$DBLIB->where("(articlesDrafts.articlesDrafts_byline LIKE '%" . $term . "%' OR articlesDrafts.articlesDrafts_headline LIKE '%" . $term . "%' OR articlesDrafts.articlesDrafts_text LIKE '%" . $term . "%')");
...
$articles = $DBLIB->get("articles", 20, ["articles.articles_thumbnail", "articles.articles_authors", "articles.articles_id", "articles.articles_published","articles.articles_slug","articlesDrafts.articlesDrafts_headline","articlesDrafts.articlesDrafts_byline"]);
$PAGEDATA['articles'] = [];
