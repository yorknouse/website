...
function similarArticles($articleid, $count = 5) {
    ...
    return $DBLIB->get("articles", $count, ["articles.articles_id","articles.articles_slug","articles.articles_published", "articles.articles_thumbnail","articlesDrafts.articlesDrafts_headline","articlesDrafts.articlesDrafts_byline"]);
}
