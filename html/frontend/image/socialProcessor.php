...
$paddingOfOverlay = 0.07; //Scale factor of how much of a gap between the bottom of the image and the overlay there should be
...
imagecopyresampled($out, $overlay, $imageNewWidth-($overlayNewWidth-1), ($imageNewHeight-($overlayNewHeight-1))-($imageNewHeight*$paddingOfOverlay), 0, 0, $overlayNewWidth, $overlayNewHeight, $overlayWidth, $overlayHeight);
