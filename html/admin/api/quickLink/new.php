...
$data = [
    "quickLinks_string" => $bCMS->sanitizeString(urldecode($_GET['string'])),
    "quickLinks_pointsTo" => str_replace($CONFIG['ROOTFRONTENDURL'], '', $bCMS->sanitizeString(urldecode($_GET['destination']))),
