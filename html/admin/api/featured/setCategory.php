...
if (!$DBLIB->update("categories", ["categories_featured" => $bCMS->sanitizeString($_POST['selection'])]))
    finish(false, ["code" => "PARAM", "message"=> "Update error"]);

$bCMS->auditLog("EDIT FEATURED", "categories", $bCMS->sanitizeString($_POST['selection']), $AUTH->data['users_userid']);
