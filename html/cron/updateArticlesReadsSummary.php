...
$summaryQuery = "
    REPLACE INTO articleReadsSummary (articles_id, read_count, updated_at)
...
if ($result === false) {
    error_log("Failed to update articleReadSummary: " . $DBLIB->getLastError());
    echo "Failed to update summary.\n";
} else {
    echo "articleReadSummary updated successfully.\n";
}
